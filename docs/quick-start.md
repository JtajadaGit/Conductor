...
│       └── conventions.instructions.md  ← Convenciones y skills (generado por /skill-registry)
...
| Sub-agentes ignoran convenciones | Registry no generado | Ejecutar `/skill-registry` |
