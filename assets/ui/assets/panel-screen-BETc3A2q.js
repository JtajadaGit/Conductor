      ...
      <div class="run-row ${f(t.verdict)===`CURSO`?`run-active`:``}">
        <div class="run-l">
          ...
          <div class="run-foot">
            ...
            ${t.hasDashboard?m`<a class="btn sm sec" href="/artifact/${e.id}/${t.name}/dashboard.html" target="_blank" aria-label="informe de ${t.name}" title="Informe del run: fases, tokens reales vs estimados, ficheros y consumo por modelo.">${l(`report`)} Informe</a>`:i}
