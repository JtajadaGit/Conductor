      ...
      <div class="run-row ${f(t.verdict)===`CURSO`?`run-active`:``}">
        <div class="run-l">
          ...
          <div class="run-foot">
            ...
            ${t.hasDashboard?m`<a class="btn sm sec" href="/artifact/${e.id}/${t.name}/dashboard.html" target="_blank" aria-label="informe de ${t.name}">${l(`report`)} Informe</a>`:i}
            ${t.phases>0?m`<a class="btn sm sec" href="/api/run/${e.id}/${t.name}/aiact" target="_blank" aria-label="AI Act de ${t.name}">${l(`shield`)} AI Act</a>`:i}
          </div>
        </div>
