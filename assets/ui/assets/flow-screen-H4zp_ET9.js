import{g as e,p as t,t as n,u as r}from"./index-Bfc-rE4S.js";var i=class extends r{constructor(...e){super(...e),this.phases=[{ph:`propose`,role:`planner`,prov:`Copilot/qwen`,does:`Propuesta: Why / What / Impact (lenguaje de dominio, sin nombres de framework).`,guard:`No avanza hasta que existe proposal.md.`},{ph:`spec`,role:`planner`,prov:`Copilot/qwen`,does:`Spec OpenSpec: requisitos SHALL + escenarios GIVEN/WHEN/THEN, con id REQ-…`,guard:`No avanza sin spec.md con cabecera delta + ≥1 requisito con escenario.`},{ph:`apply`,role:`coder`,prov:`qwen / Copilot`,does:`Implementa la spec a calidad de producción; comenta @conductor REQ-… en cada fichero.`,guard:`No avanza si el agente no escribió ningún fichero (reintenta).`},{ph:`test (opcional)`,role:`tester`,prov:`0 tokens`,does:`Ejecuta TUS pruebas reales (toggle «test» al lanzar, o checks de conductor.json) — determinista, sin LLM.`,guard:`Si fallan → ciclo fix → re-test; si no converge, escala a ti.`},{ph:`verify`,role:`reviewer`,prov:`Copilot/qwen`,does:`Revisa por escenario (lentes paralelas: correctness/security/tests) + emite Verdict.`,guard:`GATE determinista (sin LLM) + el Verdict del reviewer: si FAIL → no cierra.`}]}render(){return e`
    ...
    `}};i=n([t(`flow-screen`)],i);function a(){return e``}export{i as FlowScreen};