      ...
      <div class="run-row ${f(t.verdict)===`CURSO`?`run-active`:``}">
        <div class="run-l">
          ...
          <div class="run-foot">
            ...
            ${t.phases>0?m`<a class="btn sm sec" href="/api/run/${e.id}/${t.name}/aiact" target="_blank" aria-label="AI Act de ${t.name}" title="Expediente de transparencia (Reglamento europeo de IA): modelos, aprobaciones humanas y verificación.">${l(`shield`)} AI Act</a>`:i}
          </div>
        </div>
