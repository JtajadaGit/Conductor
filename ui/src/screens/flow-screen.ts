...
export class FlowScreen extends CElement {
  ...
  private readonly phases = [
    ...
    { ph: 'clarify', role: 'planner', prov: 'Copilot/LiteLLM', cond: 'solo complex', does: 'Preguntas que cambian QUÉ se construye (mín. imprescindible) + asunciones decididas.', guard: 'Con strictClarify, una pregunta sin responder BLOQUEA el avance.' },
