...
> **Step 0 — Pre-flight check**: Read `verify-report.md` from the change folder. If it does not exist or contains CRITICAL issues, return `status: blocked` with reason. Do NOT proceed with archiving.
