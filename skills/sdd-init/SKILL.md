...
### 9. Invoke skill-registry (conditional)
After init completes, scan for non-sdd user skills. If found → trigger skill-registry to generate `openspec/conventions.md`. If NO user skills exist → skip and note "No user skills detected — run /skill-registry after adding skills."
