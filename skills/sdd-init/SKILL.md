...
# OpenSpec standard — short context injected into all artifact prompts
context: |
  Tech stack: {language} {version}, {framework}
  Package manager: {package_manager}
  Architecture: {pattern detected in step 3}
rules:
  specs:
...
## Stack
{detected stack, versions if visible — brief, 3-5 lines max}
