...
| Metric | Value |
|--------|-------|
| Tasks total / complete / incomplete | {N} / {N} / {N} |

### Build & Tests Execution
**Build**: ✅ Passed / ❌ Failed — {error summary if failed}
**Tests**: ✅ {N} passed / ❌ {N} failed / ⚠️ {N} skipped — {failed test names if any}
**Coverage**: {N}% (threshold: {N}%) → ✅ / ⚠️ / ➖ Not available
...
|-------------|----------|------|--------|
| {REQ-01} | {scenario} | `{test file} > {test name}` | ✅ COMPLIANT / ❌ FAILING / ❌ UNTESTED / ⚠️ PARTIAL |
...
|------------|--------|-------|
| {name} | ✅ Implemented / ⚠️ Partial / ❌ Missing | {brief note} |

### Coherence (Design)
| Decision | Followed? | Notes |
|----------|-----------|-------|
| {name} | ✅ Yes / ⚠️ Deviated | {notes} |

### Issues Found
**CRITICAL**: {list or "None"} | **WARNING**: {list or "None"} | **SUGGESTION**: {list or "None"}

### Verdict
{PASS / PASS WITH WARNINGS / FAIL} — {one-line summary}
```
