...
- If a change name is provided by the orchestrator, persist as `exploration.md` in the change folder (openspec mode). If no change name is given, return analysis inline only.
